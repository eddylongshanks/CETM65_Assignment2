# Generated by Django 3.1.4 on 2021-01-09 17:09
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('building', models.CharField(blank=True, max_length=50, verbose_name='Building Name/Number')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('address_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, to='user.address')),
        ...
        migrations.CreateModel(
            name='Customer',
            fields=[
                ('propertydetails_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, to='user.propertydetails')),
                ('personaldetails_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='user.personaldetails')),
                ('has_been_contacted', models.BooleanField(default=False)),
            ],
            bases=('user.personaldetails', 'user.propertydetails'),
        ),
    ]
